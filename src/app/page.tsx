...
import { Zap, Archive, FileText, BookOpen, Users, LayoutTemplate, ChevronRight } from "lucide-react";
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl p-7 sm:p-9 animate-fade-in">
      ...
      <div className="relative z-10">
        <h1 className="text-xl sm:text-2xl font-bold text-white">안녕하세요, {name}{isProfessor ? " 교수님" : "님"}</h1>
  ...
  return (
    <div className="min-h-[calc(100vh-64px)]">
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 py-24 sm:py-32 text-center">
          ...
          <h1 className="text-4xl sm:text-6xl font-bold text-white leading-tight animate-fade-in" style={{ animationDelay: "0.1s" }}>
            대학 PBL 교육의<br />
            <span className="bg-gradient-to-r from-blue-200 to-violet-200 bg-clip-text text-transparent">새로운 기준</span>
          </h1>
          ...
          <div className="flex items-center justify-center gap-4 mt-10 animate-fade-in" style={{ animationDelay: "0.3s" }}>
            <a href="/auth/signup" className="px-8 py-4 bg-white text-indigo-600 font-semibold rounded-2xl text-sm hover:bg-gray-50 transition-all duration-300 shadow-xl shadow-black/10 hover:shadow-2xl hover:-translate-y-0.5">
              무료로 시작하기
            </a>
            <a href="/contents" className="px-8 py-4 bg-white/10 text-white font-medium rounded-2xl text-sm hover:bg-white/20 transition-all duration-300 backdrop-blur-sm border border-white/20">
              콘텐츠 둘러보기
            </a>
          </div>
        </div>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 py-20 sm:py-24">
        <h2 className="text-2xl sm:text-3xl font-bold text-center text-gray-900 mb-3">왜 IC-PBL인가요?</h2>
        <p className="text-center text-gray-500 mb-14 max-w-md mx-auto">PBL 교육에 필요한 모든 것을 한 곳에서 제공합니다</p>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          {[
            ...
            <GlassCard key={feature.title} variant="card" hoverable className="rounded-3xl p-7">
              <div className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${feature.gradient} flex items-center justify-center text-white shadow-lg ${feature.shadow} mb-5`}>
                {feature.icon}
              </div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 py-20 text-center">
          ...
          <p className="text-blue-200/80 mb-8 max-w-md mx-auto">무료 회원가입 후 AI 문제설계 도구와 모든 콘텐츠를 이용할 수 있습니다</p>
          <a href="/auth/signup" className="inline-block px-10 py-4 bg-white text-indigo-600 font-semibold rounded-2xl text-sm hover:bg-gray-50 transition-all duration-300 shadow-xl shadow-black/10 hover:shadow-2xl hover:-translate-y-0.5">
            무료로 시작하기
          </a>
        </div>
      </section>
